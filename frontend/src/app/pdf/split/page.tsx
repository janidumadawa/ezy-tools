      ...
      {files.length > 0 && (
        <div className="space-y-3">
          ...
          {files.map((f: any, i: number) => (
            <a key={i} href={`${process.env.NEXT_PUBLIC_API_URL}/api/pdf/file/${f.filename}`} download className="flex items-center justify-between bg-white border border-gray-200 rounded-lg px-4 py-3 hover:bg-gray-50">
              <div className="flex items-center gap-3">
